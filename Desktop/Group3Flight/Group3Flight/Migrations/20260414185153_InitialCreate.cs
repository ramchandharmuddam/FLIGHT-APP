    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Airbus A321", 11, new TimeSpan(0, 9, 30, 0, 0), "Economy", new DateTime(2026, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 15, 0, 0), 200.30000000000001, "NK601", "Miami", 150.00m, "Houston" },
                    { 2, "Airbus A320neo", 12, new TimeSpan(0, 20, 10, 0, 0), "Basic Economy", new DateTime(2026, 7, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 12, 45, 0, 0), 300.5, "FA123", "Las Vegas", 275.00m, "Orlando" },
                    { 3, "Airbus A330", 13, new TimeSpan(0, 23, 30, 0, 0), "Business", new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 16, 0, 0, 0), 410.80000000000001, "HA789", "Honolulu", 680.00m, "San Diego" },
                    { 4, "Boeing 737 MAX", 14, new TimeSpan(0, 12, 55, 0, 0), "Economy", new DateTime(2026, 9, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 20, 0, 0), 220.40000000000001, "GN450", "Nashville", 195.00m, "Phoenix" },
                    { 5, "Boeing 737-800", 15, new TimeSpan(0, 10, 45, 0, 0), "Economy Plus", new DateTime(2026, 10, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 0, 0, 0), 350.89999999999998, "SY880", "Minneapolis", 520.00m, "Cancun" },
                    { 6, "ATR 72", 16, new TimeSpan(0, 10, 25, 0, 0), "Economy", new DateTime(2026, 11, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 10, 0, 0), 90.599999999999994, "TR222", "Tampa", 130.00m, "Key West" }
                });
